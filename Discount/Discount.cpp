...
class FlatDiscountStrategy : public DiscountStrategy{
    private:
        double amount;
    public:
        FlatDiscountStrategy(double amount) : amount(amount){}
...
class PercentDiscountStrategy : public DiscountStrategy{
    private:
        double percent;
    public:
        PercentDiscountStrategy(double percent) : percent(percent){}
        double calculate(double amount) override{
...
class DiscountStrategyManager{
    ...
    public:
        ...
        DiscountStrategy * getStrategy(StrategyType type, double param1, double param2 = 0.0){
